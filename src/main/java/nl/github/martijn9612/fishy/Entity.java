...
public class Entity {
     ...
     * 
     * @param imageName
     *            the name of the file in which the sprite is stored
     */
     ...
     * @param y
     *            - y position of the entity on the screen
     */
    ...
    public void calculateInitialBoundingbox() {
        ellipse = new Ellipse(getX() + getWidth() / 2,
                getY() + getHeight() / 2, getWidth() / 2, getHeight() / 2);
    }
