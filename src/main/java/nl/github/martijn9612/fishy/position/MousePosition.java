 ...
 * (0,0) ------ (x,0)
 * 
 * Implements the MousePosition class.
 * Software Engineering Methods Project - Group 11.
 */
public class MousePosition extends Position {

    /**
     * Creates a new MousePosition by using the 
	 ...
	 * @param positionX - x coordinate of the new MousePosition.
	 * @param positionY - y coordinate of the new MousePosition.
	 */
	...
	/**
	 * Checks if the x coordinate of the
	 * MousePosition is in between two bounds.
	 * @param lowerBound - lower bound of the x coordinate.
	 * @param upperBound - upper bound of the x coordinate.
	 * @return true if the x coordinate of the MousePosition is 
	 * in between the two bounds, false if not.
	 */
	public boolean isInBetweenX(int lowerBound, int upperBound) {
	   ...
	   /**
     * Checks if the y coordinate of the
     * MousePosition is in between two bounds.
     * @param lowerBound - lower bound of the y coordinate.
     * @param upperBound - upper bound of the y coordinate.
     * @return true if the y coordinate of the MousePosition is 
     * in between the two bounds, false if not.
     */
	 ...
	 * @param lowerBoundX - lower bound of the x coordinate.
     * @param upperBoundX - upper bound of the x coordinate.
	 * @param lowerBoundY - lower bound of the y coordinate.
	 * @param upperBoundY - upper bound of the y coordinate.
	...
	/**
	 * Checks whether this MousePosition is within the bounds 
	 * of the given rectangle object.
	 * @param rectangle - rectangle object to verify.
	 * @return true if the MousePosition is in the rectangle, false if not.
	 */
	...
	/**
	 * Translates the Mouse coordinate system into Draw coordinates.
	...
	/**
	 * Debug method which formats the contents 
	 * of the MousePosition object into a single String.
	 * @return String representation of the MousePosition.
	 */
	public String toString() {
		return "Mouse position X: " + positionX + ", Y: " + positionY;
	}
