...
/**
 * Implementation of DrawRectangle class.
...
public class DrawRectangle extends DrawPosition {
	 ...
	 * @param positionX - x coordinate of the new DrawRectangle.
	 * @param positionY - y coordinate of the new DrawRectangle.
	 * @param width - width of the new DrawRectangle.
	 * @param height - height of the new DrawRectangle.
	 */
	 ...
	 * its center and subtracting the sprite height to 
	 * translate the origin from upper left to bottom left corner.
	...
	public String toString() {
		return "Draw rectangle X: " + positionX + ", Y: " 
