...
/**
 * Implementation of the MouseRectangle class.
...
public class MouseRectangle extends MousePosition {
	 ...
	 * @param width - width of the new MouseRectangle.
	 * @param height - height of the new MouseRectangle.
	 */
	...
	/**
	 * Creates a new MouseRectangle.
	 * @param positionX - x coordinate of the MouseRectangle.
	 * @param positionY - y coordinate of the MouseRectangle.
	 * @param width - width of the new MouseRectangle.
	 * @param height - height of the new MouseRectangle.
	 */
	...
	/**
	 * Checks whether the given mouse position is 
	 * within the bounds of this rectangle object.
	 * @param position - position coordinates in the Mouse coordinate system
...
//	}
	 ...
	 * This is achieved by rotating the y-axis around
	 * its center and adding the sprite height to 
	 * translate the origin from bottom left to the upper left corner.
	 ...
	 * of the DrawRectangle object into a single String.
	 * @return String representation of the MouseRectangle.
	 */
	public String toString() {
		return "Mouse rectangle X: " + positionX + ", Y: " 
		            + positionY + ", width: " + width + ", height: " + height;
	}
}
